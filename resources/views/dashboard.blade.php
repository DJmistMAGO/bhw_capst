                ...
                <div class="card-header ribbon ribbon-top ribbon-ver border-0 ">
                    ...
                    <div class="card-title">
                        <div class="card-label">
                            <div class="font-size-h3 font-weight-bolder">1000 Total Population</div>
                        </div>
                    </div>
                </div>
                <!--end::Header-->
                        ...
                        <div class="row row-paddingless">
                            ...
                            <div class="col mt-1">
                                <div class="d-flex align-items-center mr-2">
                                    ...
                                    <div class="symbol symbol-45 symbol-light-primary mr-4 flex-shrink-0">
                                        <div class="symbol-label">
                                            <span class="svg-icon svg-icon-lg svg-icon-primary">
                                                ...
                                                <span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\legacy\metronic\theme\html\demo13\dist/../src/media/svg/icons\Clothes\Shirt.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    ...
                                    <!--begin::Title-->
                                    <div>
                                        <div class="font-size-h4 text-nowrap text-dark-75 font-weight-bolder">34,000
                                        </div>
                            ...
                            <div class="col mt-1">
                                <div class="d-flex align-items-center mr-2">
                                    ...
                                    <div class="symbol symbol-45 symbol-light-success mr-4 flex-shrink-0">
                                        <div class="symbol-label">
                                            <span class="svg-icon svg-icon-lg svg-icon-success">
                                                ...
                                                <span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\legacy\metronic\theme\html\demo13\dist/../src/media/svg/icons\Clothes\Dress.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    ...
                                    <!--begin::Title-->
                                    <div>
                                        <div class="font-size-h4 text-nowrap text-dark-75 font-weight-bolder">6,999
                                        </div>
                            ...
                            <div class="col mt-1">
                                <div class="d-flex align-items-center mr-2">
                                    ...
                                    <div class="symbol symbol-45 symbol-light-info mr-4 flex-shrink-0">
                                        <div class="symbol-label">
                                            <span class="svg-icon svg-icon-lg svg-icon-info">
                                                <!--begin::Svg Icon | path:assets/media/svg/icons/Home/Library.svg-->
                                                <span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\legacy\metronic\theme\html\demo13\dist/../src/media/svg/icons\Home\Wood1.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                        <rect x="0" y="0" width="24" height="24"/>
                                    ...
                                    <div>
                                        ...
                                        <div class="font-size-sm text-muted font-weight-bold mt-1">Family</div>
                                    </div>
                                    <!--end::Title-->
                                </div>
                            </div>
                            ...
                            <div class="col mt-1">
                                <div class="d-flex align-items-center mr-2">
                                    ...
                                    <div class="symbol symbol-45 symbol-light-danger mr-4 flex-shrink-0">
                                        <div class="symbol-label">
                                            <span class="svg-icon svg-icon-lg svg-icon-danger">
                                                <!--begin::Svg Icon | path:assets/media/svg/icons/Home/Library.svg-->
                                                <span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\legacy\metronic\theme\html\demo13\dist/../src/media/svg/icons\Home\Home.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                        <rect x="0" y="0" width="24" height="24"/>
                                    ...
                                    <div>
                                        ...
                                        <div class="font-size-sm text-muted font-weight-bold mt-1">House</div>
                                    </div>
                                    <!--end::Title-->
                                </div>
                            </div>
        ...
        <div class="col-md-6"> 
            <div class="card card-custom card-stretch gutter-b "> 
                <div class="card-header h-auto border-0"> 
                    <div class="card-title">
                        <h3 class="card-label">
                            <span class="d-block text-dark font-weight-bolder">Total Bar Chart</span> 
                        </h3>
                    </div> 
                </div> 
        ...
        <div class="col-md-6"> 
            <div class="card card-custom card-stretch gutter-b"> 
                <div class="card-header h-auto border-0"> 
                    <div class="card-title">
                        <h3 class="card-label">
                            <span class="d-block text-dark font-weight-bolder">Total Purok Population</span> 
                        </h3>
                    </div> 
                </div> 
                <div class="card-body pt-0 pb-0">
        ...
        <div class="col-md-6"> 
            <div class="card card-custom card-stretch gutter-b">
                ...
                <div class="card-header border-0 "> 
                    <div class="card-title">
                        <div class="card-label">
                            <div class="font-size-h3 font-weight-bolder">Housing Status</div>
                        </div>
                    </div>
                </div>
                <!--end::Header-->
                                ...
                                <div class="d-flex align-items-center mr-2">
                                    ...
                                    <div class="symbol symbol-45 symbol-light-primary mr-4 flex-shrink-0">
                                        <div class="symbol-label">
                                            <span class="svg-icon svg-icon-lg svg-icon-primary">
                                                <!--begin::Svg Icon | path:assets/media/svg/icons/Shopping/Cart3.svg-->
                                                <span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\legacy\metronic\theme\html\demo13\dist/../src/media/svg/icons\Map\Marker1.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                        <rect x="0" y="0" width="24" height="24"/>
                                    ...
                                    <div>
                                        ...
                                        <div class="font-size-sm text-muted font-weight-bold mt-1">H 1</div>
                                    </div> 
                                </div>
                            </div> 
                            <div class="col mt-1">
                                <div class="d-flex align-items-center mr-2">
                                    ...
                                    <div>
                                        ...
                                        <div class="font-size-sm text-muted font-weight-bold mt-1">H 2</div>
                                    </div> 
                                </div>
                            </div> 
                            <div class="col mt-1">
                                <div class="d-flex align-items-center mr-2">
                                    ...
                                    <div>
                                        ...
                                        <div class="font-size-sm text-muted font-weight-bold mt-1">H 3</div>
                                    </div> 
                                </div>
                            </div> 
                            <div class="col mt-1">
                                <div class="d-flex align-items-center mr-2">
                                    ...
                                    <div>
                                        ...
                                        <div class="font-size-sm text-muted font-weight-bold mt-1">H 4</div>
                                    </div> 
                                </div>
                            </div> 
                            <div class="col mt-1">
                                <div class="d-flex align-items-center mr-2">
                                    ...
                                    <div>
                                        ...
                                        <div class="font-size-sm text-muted font-weight-bold mt-1">H 5</div>
                                    </div> 
                                </div>
                            </div> 
                            <div class="col mt-1">
                                <div class="d-flex align-items-center mr-2">
                                    ...
                                    <div>
                                        ...
                                        <div class="font-size-sm text-muted font-weight-bold mt-1">H 6</div>
                                    </div> 
                                </div>
                            </div> 
                        </div>
        ...
        <div class="col-md-6"> 
            <div class="card card-custom gutter-b">
                ...
                <div class="card-header border-0 "> 
                    <div class="card-title">
                        <div class="card-label">
                            <div class="font-size-h3 font-weight-bolder">Source of Water</div>
                        </div>
                    </div>
                </div>
                <!--end::Header-->
                                ...
                                <div class="d-flex align-items-center mr-2">
                                    ...
                                    <div class="symbol symbol-45 symbol-light-primary mr-4 flex-shrink-0">
                                        <div class="symbol-label">
                                            <span class="svg-icon svg-icon-lg svg-icon-primary">
                                                <!--begin::Svg Icon | path:assets/media/svg/icons/Shopping/Cart3.svg-->
                                                <span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\legacy\metronic\theme\html\demo13\dist/../src/media/svg/icons\Home\Water-mixer.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                        <polygon points="0 0 24 0 24 24 0 24"/>
                                    ...
                                    <div>
                                        ...
                                        <div class="font-size-sm text-muted font-weight-bold mt-1">Level 1</div>
                                    </div> 
                                </div>
                            </div> 
                            <div class="col mt-1">
                                <div class="d-flex align-items-center mr-2">
                                    ...
                                    <div>
                                        ...
                                        <div class="font-size-sm text-muted font-weight-bold mt-1">Level 2</div>
                                    </div> 
                                </div>
                            </div> 
                            <div class="col mt-1">
                                <div class="d-flex align-items-center mr-2">
                                    ...
                                    <div>
                                        ...
                                        <div class="font-size-sm text-muted font-weight-bold mt-1">Level 3</div>
                                    </div> 
                                </div>
                            </div> 
                        </div>
...
<script>
    var options = {
        ...
        xaxis: {
          categories: ['PWD', 'Voter', 'Senior Citizen', 'Sanitation', 'Iodize Salt', 'Herbal', 'Electrification', 'Animal', 'Vehicle'],
        },
        fill: {
          opacity: 1
        }
